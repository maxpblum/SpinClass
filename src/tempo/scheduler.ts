...
import {getHead, getTail, isEmptyList, makeList, LinkedList} from '../linked_list.js';
...
const initialState: State = {changes: makeList([{tempo: 50, time: 0}, {tempo: 60, time: 1000}, {tempo: 70, time: 2000}, {tempo: 80, time: 3000}, {tempo: 90, time: 4000}, {tempo: 100, time: 5000}])};

function reducer(s: State, input: NewTime): {newState: State, output?: NewTempo} {
